...
In addition to the important policy questions indicated above, this dissertation will emphasize the development of the \texttt{multilevelPSA} package for R. This package implements new methods for the estimation of propensity score models with multilevel, or clustered, data and will be presented within the context of traditional, non-clustered, propensity score analysis. Moreover, graphics will be emphasized for the analysis and interpretation of results. 
