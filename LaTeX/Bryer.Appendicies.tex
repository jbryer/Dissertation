...
\input{../Tables2009/g4Reading-desc.tex}
\input{../Tables2009/g4read-unadjscore.tex} \clearpage

\input{../Tables2009/g8Math-desc.tex}
\input{../Tables2009/g8math-unadjscore.tex} \clearpage

\input{../Tables2009/g8Reading-desc.tex}
...
\caption[Multilevel PSA difference plot logistic regression AIC: Grade 4 reading]{Multilevel PSA difference plot logistic regression AIC: Grade 4 reading. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
\end{figure}
...
\caption[Multilevel PSA difference plot classification trees: Grade 4 reading]{Multilevel PSA difference plot classification trees: Grade 4 reading. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
...
\caption[Multilevel PSA difference plot logistic regression: Grade 8 math]{Multilevel PSA difference plot logistic regression: Grade 8 math. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
\end{figure}
...
\caption[Multilevel PSA difference plot logistic regression AIC: Grade 8 math]{Multilevel PSA difference plot logistic regression AIC: Grade 8 math. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
\end{figure}
...
\caption[Multilevel PSA difference plot classification trees: Grade 8 math]{Multilevel PSA difference plot classification trees: Grade 8 math. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
...
\caption[Multilevel PSA difference plot logistic regression: Grade 8 reading]{Multilevel PSA difference plot logistic regression: Grade 8 reading. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
\end{figure}
...
\caption[Multilevel PSA difference plot logistic regression AIC: Grade 8 reading]{Multilevel PSA difference plot logistic regression AIC: Grade 8 reading. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
\end{figure}
...
\caption[Multilevel PSA difference plot classification trees: Grade 8 reading]{Multilevel PSA difference plot classification trees: Grade 8 reading. Each blue point represents the overall mean difference between charter and traditional public schools for each state. The green bars are the state level confidence intervals. The dashed green lines Bonferroni-\v{S}id\'{a}k \cite<\textit{c.f.}>{Abdi2007} adjusted confidence intervals. The vertical blue and green lines represent the overall, national difference and confidence interval, respectively. The size of the point is proportional to the number of students in the sample from that state.}
\end{center}
