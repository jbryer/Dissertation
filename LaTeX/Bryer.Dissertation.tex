...
The \citeA{NAPCS2010a} rates the quality of charter schools using a 4-point rubric across 20 components (see \hyperref[NAPCSrubric]{Appendix L}). The resulting ratings have a maximum value of 208. These ratings will be compared to the effect sizes from the multilevel PSA (using standardized mean differences). The correlation for each grade and subject will be evaluated to be small, moderate, or strong using \citeauthor{Cohen1988}'s \citeyear{Cohen1988} thresholds of 0.10, 0.30, and 0.50, respectively.
